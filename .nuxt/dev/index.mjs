import 'file:///project/fmb-ui/node_modules/unenv/runtime/polyfill/fetch.node.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file:///project/fmb-ui/node_modules/std-env/dist/index.mjs';
import { toEventHandler, defineEventHandler, handleCacheHeaders, createEvent, createApp, createRouter, lazyEventHandler, eventHandler, useQuery } from 'file:///project/fmb-ui/node_modules/h3/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///project/fmb-ui/node_modules/ohmyfetch/dist/node.mjs';
import destr from 'file:///project/fmb-ui/node_modules/destr/dist/index.mjs';
import { createRouter as createRouter$1 } from 'file:///project/fmb-ui/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file:///project/fmb-ui/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///project/fmb-ui/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///project/fmb-ui/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///project/fmb-ui/node_modules/unstorage/dist/index.mjs';
import _unstorage_drivers_fs from 'file:///project/fmb-ui/node_modules/unstorage/drivers/fs.mjs';
import { withQuery, joinURL } from 'file:///project/fmb-ui/node_modules/ufo/dist/index.mjs';
import { createRenderer } from 'file:///project/fmb-ui/node_modules/vue-bundle-renderer/dist/index.mjs';
import devalue from 'file:///project/fmb-ui/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { snakeCase } from 'file:///project/fmb-ui/node_modules/scule/dist/index.mjs';
import htmlTemplate from '/project/fmb-ui/.nuxt/views/document.template.mjs';
import { renderToString as renderToString$2 } from 'file:///project/fmb-ui/node_modules/vue/server-renderer/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/project/fmb-ui/server/assets"}];
...
storage.mount('root', _unstorage_drivers_fs({"driver":"fs","base":"/project/fmb-ui"}));
storage.mount('src', _unstorage_drivers_fs({"driver":"fs","base":"/project/fmb-ui/server"}));
storage.mount('build', _unstorage_drivers_fs({"driver":"fs","base":"/project/fmb-ui/.nuxt"}));
storage.mount('cache', _unstorage_drivers_fs({"driver":"fs","base":"/project/fmb-ui/.nuxt/cache"}));
...
const _277f2e = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _277f2e, lazy: true, method: undefined },
  { route: '/**', handler: _277f2e, lazy: true, method: undefined }
];
...
const getClientManifest = cachedImport(() => import('/project/fmb-ui/.nuxt/dist/server/client.manifest.mjs'));
const getSSRApp = !process.env.NUXT_NO_SSR && cachedImport(() => import('/project/fmb-ui/.nuxt/dist/server/server.mjs'));
